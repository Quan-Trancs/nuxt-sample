...
<template>
  ...
  >
    <div class="video-wrap" @click="toggle()">
      <div v-if="loadError" class="load-error">视频加载失败</div>
    ...
    <div class="controller">
      <div class="icons icons-left">
        ...
        <div class="volume">
          ...
          >
            <div ref="volumeBarRef" class="volume-bar">
      ...
      >
        ...
        <div class="bar">
          <div class="loaded" :style="{ width: loadedBarWidth }" />
