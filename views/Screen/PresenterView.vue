  ...
  <div class="presenter-view">
    <div class="toolbar">
      ...
      <div
        ...
        "
      >
        <IconOffScreenOne v-if="fullscreenState" class="tool-icon" />
        <IconFullScreenOne v-else class="tool-icon" />
...
const { slides, slideIndex, viewportRatio, currentSlide } = storeToRefs(
  useSlidesStore()
)
...
watch(slideIndex, () => {
  nextTick(() => {
    ...
    const offsetLeft =
      activeThumbnailRef.offsetLeft + activeThumbnailRef.clientWidth / 2
