...
<template>
  ...
  >
    ...
    >
      <div class="operates">
        ...
        <MultiSelectOperate
          ...
          :scale-multi-element="scaleMultiElement"
        />
        <Operate
          ...
          :is-selected="activeElementIdList.includes(element.id)"
          :is-active="handleElementId === element.id"
          :is-active-group-element="activeGroupElementId === element.id"
          :is-multi-select="activeElementIdList.length > 1"
          :rotate-element="rotateElement"
          :scale-element="scaleElement"
          :open-link-dialog="openLinkDialog"
          :drag-line-element="dragLineElement"
          :move-shape-keypoint="moveShapeKeypoint"
        />
        <ViewportBackground />
      </div>
    ...
    <div v-if="spaceKeyState" class="drag-mask" />

    <Ruler
      v-if="showRuler"
      :viewport-styles="viewportStyles"
      :element-list="elementList"
    />
