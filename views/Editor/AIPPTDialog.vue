<template>
  <div class="aippt-dialog">
    <div class="header">
      ...
      >
      <span v-else class="subtite"
        >在下方输入您的PPT主题，并适当补充信息，如行业、岗位、学科、用途等</span
      >
    </div>
    ...
    <div v-if="step === 'outline'" class="preview">
      <pre v-if="outlineCreating" ref="outlineRef">{{ outline }}</pre>
