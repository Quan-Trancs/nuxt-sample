...
<template>
  <div class="chart-style-panel">
    ...
    <template
      v-if="
        ['bar', 'column', 'area', 'line'].includes(handleChartElement.chartType)
      "
    >
      <div class="row">
        <Checkbox
      ...
      <Popover trigger="click" style="width: 60%">
        <template #content>
          <ColorPicker
            ...
            @update:model-value="(value) => updateTextColor(value)"
          />
        </template>
    ...
    <div class="row">
      ...
      <Popover v-model:value="themesVisible" trigger="click" style="width: 60%">
        <template #content>
          <div class="themes">
            ...
            <div class="preset-themes" :style="{ marginBottom: '-10px' }">
              <div
                class="preset-theme"
                @click="setThemeColors(theme.themeColors)"
              >
                <div
    ...
    >
      <ThemeColorsSetting
        :colors="themeColors"
        @update="(colors) => setThemeColors(colors)"
      />
    </Modal>
  </div>
</template>
