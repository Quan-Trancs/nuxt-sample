  ...
  <div class="chart-data-editor">
    <div class="editor-content">
      <div class="handler">
        <div class="col-header">
          <div v-for="colIndex in 7" :key="colIndex" class="col-header-item">
            <div class="col-key">{{ alphabet[colIndex - 1] }}</div>
          </div>
        </div>
        <div class="row-header">
          <div v-for="rowIndex in 31" :key="rowIndex" class="row-header-item">
    ...
    <div class="btns">
      <div class="left">
        ...
        <Popover
          v-model:value="chartTypeSelectVisible"
          trigger="click"
          placement="top"
        >
          <template #content>
