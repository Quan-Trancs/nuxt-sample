<template>
  <div class="shape-style-panel">
    ...
    <div class="row">
      ...
      />
      <div v-if="fillType !== 'pattern'" style="width: 10px" />
      <Popover v-if="fillType === 'fill'" trigger="click" style="flex: 1">
        <template #content>
          <ColorPicker
            :model-value="fill"
            @update:model-value="(value) => updateFill(value)"
          />
        </template>
    ...
    <template v-if="fillType === 'gradient'">
      ...
      <div class="row">
        ...
        <Popover trigger="click" style="width: 60%">
          <template #content>
            <ColorPicker
              :model-value="gradient.colors[currentGradientIndex].color"
      ...
      <div v-if="gradient.type === 'linear'" class="row">
    ...
    <template v-if="handleShapeElement.text?.content">
      ...
      >
        <RadioButton v-tooltip="'顶对齐'" value="top" style="flex: 1"
          ><IconAlignTextTopOne
        /></RadioButton>
        <RadioButton v-tooltip="'居中'" value="middle" style="flex: 1"
          ><IconAlignTextMiddleOne
        /></RadioButton>
        <RadioButton v-tooltip="'底对齐'" value="bottom" style="flex: 1"
