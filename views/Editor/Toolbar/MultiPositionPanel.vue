<template>
  <div class="multi-position-panel">
    ...
    <ButtonGroup v-if="displayItemCount > 2" class="row">
    ...
    <ButtonGroup class="row">
      <Button :disabled="!canCombine" style="flex: 1" @click="combineElements()"
        ><IconGroup style="margin-right: 3px" />组合</Button
      >
      <Button
        :disabled="canCombine"
        style="flex: 1"
        @click="uncombineElements()"
        ><IconUngroup style="margin-right: 3px" />取消组合</Button
      >
    </ButtonGroup>
  </div>
</template>
