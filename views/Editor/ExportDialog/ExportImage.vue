<template>
  <div class="export-img-dialog">
    <div class="thumbnails-view">
      <div ref="imageThumbnailsRef" class="thumbnails">
        <ThumbnailSlide
    ...
    <div class="configs">
      <div class="row">
        ...
        <RadioGroup v-model:value="format" class="config-item">
      ...
      <div class="row">
        ...
        <RadioGroup v-model:value="rangeType" class="config-item">
      ...
      <div v-if="rangeType === 'custom'" class="row">
