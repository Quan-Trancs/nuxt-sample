<template>
  <div class="element-toolbar">
    ...
    <div class="content">
      <div v-if="activeTab === 'style'" class="style">
      ...
      <div v-if="activeTab === 'common'" class="common">
        <ButtonGroup class="row">
          <Button style="flex: 1" @click="copyElement()"
            ><IconCopy class="icon" /> 复制</Button
          >
          <Button style="flex: 1" @click="deleteElement()"
            ><IconDelete class="icon" /> 删除</Button
          >
        </ButtonGroup>
        ...
        <ButtonGroup class="row">
          <Button
            ...
            ><IconAlignLeft class="icon" /> 左对齐</Button
          >
          <Button
            style="flex: 1"
            @click="alignElementToCanvas(ElementAlignCommands.HORIZONTAL)"
            ><IconAlignVertically class="icon" /> 水平居中</Button
          >
          <Button
            style="flex: 1"
            @click="alignElementToCanvas(ElementAlignCommands.RIGHT)"
            ><IconAlignRight class="icon" /> 右对齐</Button
          >
        </ButtonGroup>
        <ButtonGroup class="row">
          <Button
            ...
            ><IconAlignTop class="icon" /> 上对齐</Button
          >
          <Button
            style="flex: 1"
            @click="alignElementToCanvas(ElementAlignCommands.VERTICAL)"
            ><IconAlignHorizontally class="icon" /> 垂直居中</Button
          >
          <Button
            style="flex: 1"
            @click="alignElementToCanvas(ElementAlignCommands.BOTTOM)"
            ><IconAlignBottom class="icon" /> 下对齐</Button
          >
        </ButtonGroup>
      </div>
    </div>
